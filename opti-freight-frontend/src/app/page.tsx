...
export default function LandingPage() {
  ...
  const content = {
    en: {
      ...
      feature2Description: "Start your investment portfolio with as little as $200. No need for large capital outlays to enter the logistics market.",
    ...
    es: {
      ...
      feature2Description: "Comienza tu cartera de inversiones con tan solo $200. No se necesitan grandes desembolsos de capital para ingresar al mercado logístico.",
